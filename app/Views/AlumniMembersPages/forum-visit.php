        ...
        <div class="mt-10">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb my-0 ms-2 mb-4">
                    ...
                    <li class="breadcrumb-item">
                        <a href="/AlumniController/ForumMainPage" class="text-primary">Forum</a>
                    </li>
                ...
                <div class="card mb-3">
                    <div class="card-body">
                        <div class="text-center">
                            <form id="forum_form" action="/AlumniController/ModifyForumPhoto" method="post" enctype="multipart/form-data">
                        ...
                        <div class="nav-align-top mb-3">
                            ...
                            <div class="tab-content col-sm-12">
                                ...
                                <div class="tab-pane fade show active" id="navs-pills-top-caption" role="tabpanel">
                                    <form method="post" action="/AlumniController/ForumUpload/<?= $forum_post_id ?>" enctype=" multipart/form-data">
                            ...
                            <div class="mt-2">
                                ...
                                <?php if ($other_forums): ?>
                                    <?php foreach ($other_forums as $other_forum): ?>
                                        <a href="/AlumniController/ForumVisit/<?= $other_forum['forum_id'] ?>" class=" list-group-item list-group-item-action p-2">
                                            <?= $other_forum['forum_name'] ?></a>
                                    <?php endforeach; ?>
                                <?php else: ?>
                                        ...
                                        <div class="card-body pb-1">
                                            <div class="row">
                                                ...
                                                <?php if ($forums['posted_by'] == session()->get('name')): ?>
                                                    <!-- DELETE -->
                                                    <div class="col-sm-1">
                                                        <a onclick="return confirm('Are you sure you want to delete this post?')" class="text-black" href="/AlumniController/DeleteForumPost/<?= $forums['forum_post_id'] ?>/<?= $forum_post_id ?>"><i class="menu-icon tf-icons bx bx-trash"></i></a>
                                                    </div>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="accordion-item">
                                            ...
                                            <div id="comment-<?= $forums['forum_post_id'] ?>" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                                                <div class="accordion-body">
                                                        ...
                                                        <?php if ($_column['forum_post_id'] == $forums['forum_post_id']): ?>
                                                            ...
                                                            <?php if ($_column['user_id'] == session()->get('user_id')): ?>
                                                                ...
                                                                <div class="comment-section">
                                                                    ...
                                                                    <div class="d-flex align-items-start mb-3">
                                                                        ...
                                                                        <div class="flex-grow-1">
                                                                            <div class="">
                                                                                ...
                                                                                <a class="text-black ms-2" href="/AlumniController/ForumCommentDelete/<?= $_column['comment_id'] ?>"><i class="bx bx-trash"></i></a>
                                                                            </div>
                                                                            <div>
                                                                                ...
                                                                                <div class="d-flex align-items-start mb-3 ms-5 position-relative">
                                                                                    ...
                                                                                    <div class="flex-grow-1">
                                                                                        <div class="">
                                                                                            ...
                                                                                            <a class="text-black ms-2" href="/AlumniController/ForumCommentSubDelete/<?= $_column_sub_comment['forum_comments_sub_id'] ?>"><i class="bx bx-trash"></i></a>
                                                                                        </div>
                                                                                        <div>
                                                                    ...
                                                                    <!-- REPLY FORM -->
                                                                    <form action="/AlumniController/ForumCommentSub" method="post">
                                                                        <div class="d-flex align-items-start mb-3 ms-5 position-relative">
                                                                            <div class="flex-grow-1">
                                                    ...
                                                    <div class="row mt-2">
                                                        <form action="/AlumniController/ForumCommentCreate" method="post">
                                                            <div class="row">
