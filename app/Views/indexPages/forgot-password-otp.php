        ...
        <div class="authentication-inner">
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="formAuthentication" class="mb-3" action="/LoginController/ForgotPasswordVerifiedOTP" method="post">
                        <div class="mb-3">
                            <input type="text" class="form-control text-center fs-large" name="_user_forgot_password_otp" placeholder="XXXXXX" autofocus required />
                    ...
                    <p class="text-center">
                        <a href="/LoginController/UserType"><i class="bx bx-chevron-left"></i> Return</a>
                    </p>
                </div>
            </div>
        </div>
