...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="mt-10">
        <ol class="breadcrumb my-0 ms-0 mb-4">
            ...
            <li class="breadcrumb-item">
                <a href="/AlumniController/LearningJourney"
                    onclick="return confirm('Photos might not be saved. Are you certain you want to go back?')"
                    class="text-primary">Dashboard</a>
            </li>
            <li class="breadcrumb-item active"><span>Dashboard Upload</span></li>
        </ol>
    </div>
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="m-0">Create New Post: Dashboard</h3>
        </div>
        <hr class="m-0">
        <form id="imageUploadForm" action="/AlumniAssociationController/DashboardUpload" method="post"
            ...
            <div class="card-footer border-top text-end">
                <button type="button" id="uploadButton" class="btn btn-primary me-2 pe-5 ps-5" onclick="submitForm()"
                    disabled>Upload</button>
                <a href="/AlumniAssociationController/Dashboard"
                    onclick="return confirm('Photos might not be saved. Are you certain you want to go back?')"
...
<script>
    let imageCount = 0;
    let folderNameInput = document.querySelector('input[name="title"]');
