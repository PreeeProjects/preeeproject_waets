            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-sm-5">
                            <p>Phone Number:
                                <?= session()->get('phone') ?: "<a href='/AlumniAssociationController/ProfileEdit'>update</a>" ?>
                            </p>
                        </div>
                    ...
                    <p>Address:
                        <?= session()->get('address') ?: "<a href='/AlumniAssociationController/ProfileEdit'>update</a>" ?>
                    </p>
                    ...
                    <p>Work:
                        <?= session()->get('work') ?: "<a href='/AlumniAssociationController/ProfileEdit'>update</a>" ?>
                    </p>
                </div>
            </div>
        </div>
