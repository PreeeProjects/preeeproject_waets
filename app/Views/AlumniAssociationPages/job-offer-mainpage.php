                    ...
                    <div class="nav-align-top mb-3">
                        ...
                        <div class="tab-content col-sm-12">
                            ...
                            <div class="tab-pane fade show active" id="navs-pills-top-caption" role="tabpanel">
                                <form method="post" action="/AlumniAssociationController/JobOfferUpload" enctype="multipart/form-data">
                            ...
                            <div class="tab-pane fade" id="navs-pills-top-image" role="tabpanel">
                                <form method="post" action="/AlumniAssociationController/JobOfferUpload" enctype="multipart/form-data">
                                    ...
                                    <div class="text-center mb-2">
                                        <button type="button" id="add_image_only" class="btn btn-outline-primary btn-sm ps-5 pe-5">Choose Image</button>
                            ...
                            <div class="tab-pane fade" id="navs-pills-top-imageCaption" role="tabpanel">
                                <form method="post" action="/AlumniAssociationController/JobOfferUpload" enctype="multipart/form-data">
                                    ...
                                    <div class="text-center mt-3">
                                        <button type="button" id="add_image" class="btn btn-outline-primary btn-sm ps-5 pe-5">Choose Image</button>
                                        <button type="submit" class="btn btn-outline-primary btn-sm ps-5 pe-5">Post</button>
                                    </div>`
                                </form>
                            </div>
                        ...
                        <div class="mt-2">
                            ...
                            <?php if (!empty($assistance)) : ?>
                                <?php foreach ($assistance as $assistances) : ?>
                                    <a href="/AlumniAssociationController/AssistanceMainpage" class="list-group-item list-group-item-action p-2"><?= $assistances['title'] ?></a>
                                <?php endforeach; ?>
                            <?php else : ?>
