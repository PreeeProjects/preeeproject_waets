...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="card mb-4">
        ...
        <hr class="mt-0">
        <form action="/AlumniAssociationController/SectionThree" method="get">
                ...
                <div class="col-sm-7">
                    <div class="card-body pt-0">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select class="form-select" name="question_9" id="question_9" required>
                                <option disabled selected value="<?= session()->get('question9') ?>">Province</option>
                                ...
                                <option value="ARMM">Region 1</option>
            ...
            <div class="card-footer pt-0">
                <div class="d-flex justify-content-center">
                    <a href="/AlumniAssociationController/SectionOne" type="button"
