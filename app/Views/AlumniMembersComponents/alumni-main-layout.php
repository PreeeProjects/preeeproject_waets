...
<body>
    <div class="layout-wrapper layout-content-navbar">
        <div class="layout-container">
            <!-- Sidebar -->
            <?= $this->include('/AlumniMembersComponents/nav-side') ?>

            <!-- Layout container -->
            <div class="layout-page" style="background-color: #F2E6E6;">
                <!-- Navbar -->
                <?= $this->include('/AlumniMembersComponents/nav-top') ?>
                ...
                <div class="content-wrapper">
                    ...
                    <!-- Footer -->
                    <?= $this->include('/AlumniMembersComponents/footer') ?>
